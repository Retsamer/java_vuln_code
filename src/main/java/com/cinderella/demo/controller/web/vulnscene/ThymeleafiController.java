...
/**
 * @author Cinderella
 * @time 2021/9/16 15:53
 * @Description
 **/
@RestController
public class ThymeleafiController {
    ...
    public String thymeleaf01(){
        logger.info("[+] start check thymeleaf01 vuln and repaire");
        String str = "thymeleafi01";
        Gson gson = new Gson();
    ...
    public String thymeleaf02(){
        logger.info("[+] start check thymeleaf02 vuln and repaire");
        String str1 = "thymeleafi02";
        String str2 = "thymeleafi01";
        Gson gson = new Gson();
        VulnPath vulnPath = vulnPathMapper.findVuln(str1);
        VulnRepaire vulnRepaire = vulnRepaireMapper.findRepaireBySymbol(str2);
        List<VulnRepaire> tmp = new LinkedList<>();
        tmp.add(vulnRepaire);
        vulnPath.setVulnRepaire(tmp);
        return gson.toJson(vulnPath);

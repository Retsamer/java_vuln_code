...
public class SafeDomainParser {
    ...
    public SafeDomainParser() {
        ...
        String safeDomainClassPath = "urlxml" + File.separator + "url_safe_domain.xml";
        ...
        String ssrfSafeDomainClassPath = "urlxml" + File.separator + "ssrf_safe_domain.xml";
